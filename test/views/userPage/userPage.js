...
import UserPage from '../../../js/views/userPage/UserPage';

describe('the user page', () => {
  describe('has a select tab method', () => {
    it('which defaults to Store if no tab is set in options when the view is created', () => {
      const userPage = new UserPage();
      console.log(userPage.currentTabView);
      console.log(userPage.currentTabView instanceof userPage.Store);
    });
     /*
    it('which defaults the tab to Store if an invalid targ parameter is passed in', () => {
      const userPage = new UserPage();
